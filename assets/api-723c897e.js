 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ws=()=>Es().__FIREBASE_DEFAULTS__,vs=()=>{if(typeof process>"u"||typeof process.env>"u")return;const t={}.__FIREBASE_DEFAULTS__;if(t)return JSON.parse(t)},bs=()=>{if(typeof document>"u")return;let t;try{t=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=t&&ar(t[1]);return e&&JSON.parse(e)},Mt=()=>{try{return ws()||vs()||bs()}catch(t){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${t}`);return}},Is=t=>{var e,n;return(n=(e=Mt())===null||e===void 0?void 0:e.emulatorHosts)===null||n===void 0?void 0:n[t]},cr=()=>{var t;return(t=Mt())===null||t===void 0?void 0:t.config},lr=t=>{var e;return(e=Mt())===null||e===void 0?void 0:e[`_${t}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const U=new ur("@firebase/app"),oo="@firebase/app-compat",ao="@firebase/analytics-compat",co="@firebase/analytics",lo="@firebase/app-check-compat",uo="@firebase/app-check",ho="@firebase/auth",fo="@firebase/auth-compat",po="@firebase/database",mo="@firebase/data-connect",go="@firebase/database-compat",_o="@firebase/functions",yo="@firebase/functions-compat",Eo="@firebase/installations",wo="@firebase/installations-compat",vo="@firebase/messaging",bo="@firebase/messaging-compat",Io="@firebase/performance",To="@firebase/performance-compat",So="@firebase/remote-config",Ao="@firebase/remote-config-compat",Ro="@firebase/storage",Oo="@firebase/storage-compat",Co="@firebase/firestore",Po="@firebase/vertexai-preview",ko="@firebase/firestore-compat",No="firebase",Do="10.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bo="firebase-heartbeat-database",Ho=1,ye="firebase-heartbeat-store";let ft=null;function mr(){return ft||(ft=to(Bo,Ho,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(ye)}catch(n){console.warn(n)}}}}).catch(t=>{throw q.create("idb-open",{originalErrorMessage:t.message})})),ft}async function jo(t){try{const n=(await mr()).transaction(ye),r=await n.objectStore(ye).get(gr(t));return await n.done,r}catch(e){if(e instanceof J)U.warn(e.message);else{const n=q.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});U.warn(n.message)}}}async function hn(t,e){try{const r=(await mr()).transaction(ye,"readwrite");await r.objectStore(ye).put(e,gr(t)),await r.done}catch(n){if(n instanceof J)U.warn(n.message);else{const r=q.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});U.warn(r.message)}}}function gr(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ko(t){_e(new ae("platform-logger",e=>new io(e),"PRIVATE")),_e(new ae("heartbeat",e=>new Wo(e),"PRIVATE")),ne(It,un,t),ne(It,un,"esm2017"),ne("fire-js","")}Ko("");function Ft(t,e){var n={};for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&e.indexOf(r)<0&&(n[r]=t[r]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(t);i<r.length;i++)e.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(t,r[i])&&(n[r[i]]=t[r[i]]);return n}function _r(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Go=_r,yr=new Ie("auth","Firebase",_r());/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ve=new ur("@firebase/auth");function Jo(t,...e){Ve.logLevel<=E.WARN&&Ve.warn(`Auth (${Se}): ${t}`,...e)}function Me(t,...e){Ve.logLevel<=E.ERROR&&Ve.error(`Auth (${Se}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function S(t,...e){throw Bt(t,...e)}function R(t,...e){return Bt(t,...e)}function Er(t,e,n){const r=Object.assign(Object.assign({},Go()),{[e]:n});return new Ie("auth","Firebase",r).create(e,{appName:t.name})}function K(t){return Er(t,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function Bt(t,...e){if(typeof t!="string"){const n=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=t.name),t._errorFactory.create(n,...r)}return yr.create(t,...e)}function p(t,e,...n){if(!t)throw Bt(e,...n)}function k(t){const e="INTERNAL ASSERTION FAILED: "+t;throw Me(e),new Error(e)}function M(t,e){t||k(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function da(t,e){const n=await vr(t,{},async()=>{const r=Te({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:i,apiKey:s}=t.config,o=br(t,i,"/v1/token",`key=${s}`),a=await t._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",wr.fetch()(o,{method:"POST",headers:a,body:r})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function ha(t,e){return X(t,"POST","/v2/accounts:revokeToken",ee(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wn(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Cr(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Ar(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(kr(e))return"Blackberry";if(Nr(e))return"Webos";if(Rr(e))return"Safari";if((e.includes("chrome/")||Or(e))&&!e.includes("edge/"))return"Chrome";if(Pr(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=t.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function Ar(t=v()){return/firefox\//i.test(t)}function Rr(t=v()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Or(t=v()){return/crios\//i.test(t)}function Cr(t=v()){return/iemobile/i.test(t)}function Pr(t=v()){return/android/i.test(t)}function kr(t=v()){return/blackberry/i.test(t)}function Nr(t=v()){return/webos/i.test(t)}function $t(t=v()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function fa(t=v()){var e;return $t(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function pa(){return Cs()&&document.documentMode===10}function Dr(t=v()){return $t(t)||Pr(t)||Nr(t)||kr(t)||/windows phone/i.test(t)||Cr(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lr(t,e=[]){let n;switch(t){case"Browser":n=wn(v());break;case"Worker":n=`${wn(v())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Se}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gr{constructor(e,n,r,i,s=!1){this.auth=e,this.resolver=r,this.user=i,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:r,postBody:i,tenantId:s,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:n,sessionId:r,tenantId:s||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(l){this.reject(l)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return lc;case"linkViaPopup":case"linkViaRedirect":return dc;case"reauthViaPopup":case"reauthViaRedirect":return uc;default:S(this.auth,"internal-error")}}resolve(e){M(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){M(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const el=5*60,tl=lr("authIdTokenMaxAge")||el;let Ln=null;const nl=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>tl)return;const i=n==null?void 0:n.token;Ln!==i&&(Ln=i,await fetch(t,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function Un(t=Fo()){const e=fr(t,"auth");if(e.isInitialized())return e.getImmediate();const n=Ra(t,{popupRedirectResolver:Yc,persistence:[ac,Ja,Vr]}),r=lr("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(r,location.origin);if(location.origin===s.origin){const o=nl(s.toString());za(n,o,()=>o(n.currentUser)),Wa(n,a=>o(a))}}const i=Is("auth");return i&&Ca(n,`http://${i}`),n}function rl(){var t,e;return(e=(t=document.getElementsByTagName("head"))===null||t===void 0?void 0:t[0])!==null&&e!==void 0?e:document}wa({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=i=>{const s=R("internal-error");s.customData=i,n(s)},r.type="text/javascript",r.charset="UTF-8",rl().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Zc("Browser");var il="firebase",sl="10.14.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ne(il,sl,"app");function ol(){return pr({apiKey:"AIzaSyD2mlSVl5nKOBS7cA_XypDy4UBqPz68AHQ",authDomain:"vnhappy7-dev.firebaseapp.com",projectId:"vnhappy7-dev",storageBucket:"vnhappy7-dev.appspot.com",messagingSenderId:"565779280846",appId:"1:565779280846:web:5fe8817b8c1bb119efb19f",measurementId:"G-YLRX0JPRDV"}),{firebaseLogin:async(n,r)=>Va(Un(),n,r).then(i=>{const s=i.user;return s.getIdToken().then(o=>(console.log("user accessToken: ",o),console.log("firebaseUser: ",s),{firebaseUser:s,accessToken:o}))}),getAuth:Un,firebaseLogout:qa}}const Ge=ei(rr.get("token")),{getAuth:al}=ol(),Yr=al(),T=ps.create({baseURL:"https://vnhappy7-dev.coupletunnel.com/ops",timeout:5e3,headers:{"Content-Type":"application/json","authorization-firebase":Ge.value?`${Ge.value}`:""}}),Xr=t=>{Ge.value=t,T.defaults.headers["authorization-firebase"]=`${t}`,rr.set("token",t,{expires:7})};var Mn;(Mn=Yr.currentUser)==null||Mn.getIdToken().then(t=>{console.log("idToken",t),Xr(t)});console.log("firebaseAuth",Yr);const cl=()=>{Ge.value=""},ll=async()=>{try{return T.post("/login")}catch(t){throw console.log("Error in login:",t),t}},ul=t=>T.patch("user",t),dl=t=>{const{category:e,planId:n,planParams:r}=t;return T.post(`plan/${e}/${n}/order`,r)},hl=t=>{const{category:e,orderId:n,planParams:r}=t;return T.put(`plan/${e}/order/${n}`,r)},fl=t=>{const{orderId:e,paymentParams:n}=t;return T.post(`plan/escort/order/${e}/payment`,n)},pl=t=>T.get("/order/detail",{params:t}),ml=t=>T.get(`/order/detail/${t}`),gl=(t,e,n)=>T.post(`/plan/escort/${t}/estimateFee`,e,{params:n}),_l=t=>T.put(`plan/escort/order/${t.orderId}`,t.planParams),yl=t=>T.post(`plan/escort/order/${t.orderId}/assign-guides`,{guides:t.guideIds}),El=t=>T.post(`/order/${t.orderId}/manual-operation-status`,{manualOperationStatus:t.manualOperationStatus}),vl={axiosInstance:T,login:ll,removeAuthToken:cl,setAuthToken:Xr,createOrder:dl,updateOrder:hl,updateUser:ul,createPayment:fl,getOrders:pl,getOrderDetail:ml,getEstimateFee:gl,updateEscortOrder:_l,assignGuidesToOrder:yl,updateManualOperationStatus:El};export{vl as a,ol as u};
//# sourceMappingURL=api-723c897e.js.map
